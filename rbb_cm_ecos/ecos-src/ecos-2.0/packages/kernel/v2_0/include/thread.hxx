...
public:
    ...
    // Broadcom mod: Pass out the current stack.
    CYG_ADDRESS get_stack_ptr() { return stack_ptr; }
...
public:
    ...
    // If the scheduler implements SMP, provide
    // functions to set and get affinity.
    
    cyg_bool set_affinity( cyg_uint32 affinity_mask );

    cyg_uint32 get_affinity();
