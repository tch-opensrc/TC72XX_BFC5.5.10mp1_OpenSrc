...
#if ! defined( BCM_USE_HEAP_MANAGER )
...
extern "C"
{
    // Dummy function so this module gets linked in...
    void BcmMallocEcosInit( void )
    {
        cygmem_memalloc_heaps[1] = NULL;
    }
}

#endif // ! defined ( BCM_USE_HEAP_MANAGER )
