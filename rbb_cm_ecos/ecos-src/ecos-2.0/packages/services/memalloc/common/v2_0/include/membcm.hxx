#ifndef CYGONCE_MEMALLOC_MEMBCM_HXX
#define CYGONCE_MEMALLOC_MEMBCM_HXX

//==========================================================================
//
//      membcm.hxx
//
//      Broadcom pool allocator shim declarations
//
//==========================================================================
...
// Contributors: 
// Date:         2000-06-12
// Purpose:      Define membcm class interface
// Description:  Shim to use Broadcom memory allocator as system pool handler
// Usage:        #include <cyg/memalloc/membcm.hxx>
//              
//
//####DESCRIPTIONEND####
//
...
#define CYGCLS_MEMALLOC_MALLOC_IMPL Cyg_Mempool_Broadcom

#define BCM_USE_HEAP_MANAGER
...
public:
    ...
    // same arena.
    Cyg_Mempool_Broadcom( cyg_uint8 * base, cyg_int32  size,
...
#endif // ifndef CYGONCE_MEMALLOC_MEMBCM_HXX
// EOF membcm.hxx
