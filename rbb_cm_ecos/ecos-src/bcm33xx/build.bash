...
chmod +w bcm33xx.ecc
cd bcm33xx_build/
../../ecos-2.0/tools/bin/ecosconfig --config=../bcm33xx.ecc --prefix=$(pwd)/../bcm33xx_install --srcdir=$(pwd)/../../ecos-2.0/packages --no-resolve tree
rm -fv ../bcm33xx_install/lib/*.{a,o}
make -s clean
make -s -j 8
diff -qr -x target.ld ../bcm33xx_install/ ../../../../rbb_cm_src/Bfc/LibSupport/eCos/bcm33xx_install/ | grep differ | cut -d " " -f 2,4 | xargs -n2 cp -pfv
